...
class ReminderListViewController: UICollectionViewController {
    ...
    override func collectionView(_ collection: UICollectionView, willDisplaySupplementaryView view: UICollectionReusableView, forElementKind elementKind: String, at indexPath: IndexPath) {
